/**
 * @file face_reconstruction_functors.h
 * @author Matthew Bonanni (mbonanni001@gmail.com)
 * @brief Functors for face reconstruction.
 * @version 0.1
 * @date 2024-03-01
 * 
...
#ifndef FACE_RECONSTRUCTION_FUNCTORS_H
#define FACE_RECONSTRUCTION_FUNCTORS_H

namespace FaceReconstructionFunctors {
...
#endif // FACE_RECONSTRUCTION_FUNCTORS_H