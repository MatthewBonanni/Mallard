...
void Solver::calc_rhs(view_2d * solution,
    ...
    SolverFunctors::DivideVolumeFunctor divide_volume_functor(mesh->cell_volume, *rhs);
...
void Solver::calc_rhs_interior(view_3d * face_solution,
    ...
    if (physics->get_type() == PhysicsType::EULER) {
        if (riemann_solver->get_type() == RiemannSolverType::Rusanov) {
            ...
            SolverFunctors::FluxFunctor<Euler, Rusanov> flux_functor(mesh->face_normals,
                                                                     mesh->face_area,
                                                                     mesh->cells_of_face,
                                                                     *face_solution,
                                                                     *rhs,
            ...
            // Roe Riemann solver
            SolverFunctors::FluxFunctor<Euler, Roe> flux_functor(mesh->face_normals,
                                                                 mesh->face_area,
                                                                 mesh->cells_of_face,
                                                                 *face_solution,
                                                                 *rhs,
            ...
            // HLL Riemann solver
            SolverFunctors::FluxFunctor<Euler, HLL> flux_functor(mesh->face_normals,
                                                                 mesh->face_area,
                                                                 mesh->cells_of_face,
                                                                 *face_solution,
                                                                 *rhs,
            ...
            // HLLC Riemann solver
            SolverFunctors::FluxFunctor<Euler, HLLC> flux_functor(mesh->face_normals,
                                                                  mesh->face_area,
                                                                  mesh->cells_of_face,
                                                                  *face_solution,
                                                                  *rhs,
